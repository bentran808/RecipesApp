import { category, ingredient, ingredientsDetails, recipe } from 'mocks';
import {
  getRecipesByIngredient,
  mappingIngredientsDetails,
  transformCategories
} from 'utils/helpers';
...
describe('Test helpers', () => {
  ...
  test('should call function transformCategories', () => {
    const categories = [
      {
        ...category,
        recipes: [recipe]
    ...
    const actual = transformCategories(categories);
